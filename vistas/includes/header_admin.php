...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo $URL;?>img/logo-color.png">
</head>
<body>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left">
                        <a href="<?php echo $URL; ?>admin/Informes.php"><button class="dropdown-item" type="button">Informes</button></a>
                        <a href="<?php echo $URL; ?>admin/clientes.php"><button class="dropdown-item" type="button">Clientes</button></a>
                        <a href="<?php echo $URL; ?>admin/empresas.php"><button class="dropdown-item" type="button">Empresas</button></a>
                        <a href="<?php echo $URL; ?>admin/productos.php"><button class="dropdown-item" type="button">Productos</button></a>
