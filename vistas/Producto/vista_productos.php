    ...
    <section class="container">
        <div class="row col-12 my-5">
            <div class="col-12">
                ...
                <p>
                    Abejorral es un municipio con una población de 6.765 habitantes en la zona urbana y 12.331 en la
                    zona rural, lo que lo convierte en un territorio en su mayor parte campesino. El sábado es el día de
                    mercado, los campesinos sacan los productos cultivados en sus fincas para la comercialización local
                    y regional.
                    <br><br>
                    La diversidad de climas que tiene el municipio, permiten que la oferta en alimentos sea amplia.
                    Maíz, frijol, plátano, cacao, tomate, frutales como mango, mandarina, guanábana, granadilla, entre
                    otros, aquí se cultivan y muchos de estos son tipo exportación.
                    <br><br>
                    En el primer reglón de la economía abejorraleña se ubica el café. Abejorral es el principal
                    productor en el oriente Antioqueño con 3.556 hectáreas en producción.
                    <br>
                    La ganadería de leche produce alrededor de 60.000 litros por día, cuenta con 36.000 hectáreas en
                    pastos y se ubica en el segundo renglón de la economía local.
                    <br>
                    Abejorral es el cuarto municipio en Antioquia con mayor cantidad d predios certificados en buenas
                    prácticas agrícolas en aguacate tipo exportación, siendo este el tercer renglón de la economía.
                    <br>
                    La floricultura, aunque en menor parte, también hace parte de la economía de Abejorral, generando
                ...
                <div class="row contenedor d-md-flex m-4 cards-info">
                    ...
                    <div class="card m-2 col-12 col-md-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <button type="button" class="btn btn-admin mt-3" data-toggle="modal"
                                    data-target="#modal1<?php echo $cont; ?>">Ver producto</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="col mt-3 card">
                                        <img src="<?php echo $urlimagen.$fila['img1']; ?>" class="card-img-top"
                                            alt="...">
                                    </div>
                                    <div class="col mt-3">
                                    ...
                                    <div class="col mt-3">
                                        <label><i
                                                class="fas fa-envelope mr-2"></i><?php echo $fila['Correo']; ?></label>
                                    </div>
                ...
                <div class="row contenedor d-md-flex m-4 cards-info">
                    ...
                    <div class="card m-2 col-12 col-md-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <button type="button" class="btn btn-admin mt-3" data-toggle="modal"
                                    data-target="#modal<?php echo $cont; ?>">Ver producto</button>
                            </div>
                        </div>
                    </div>
