        ...
        var OneBook3D = {
            ...
            initWithData: function(FRDATA) {
                ...
                this.LNG = {
                    ...
                    left: ['Left', 'Слева'],
                    right: ['Right', 'Справа'],
                    toStart: ['Inicio', 'В начало'],
                    toEnd: ['To end', 'В конец'],

                    hlpGoToHomelink: ['Open homepage', 'Открыть домашнюю страницу'],
                    hlpClickToOpen: ['Click para abrir', 'Открой меня'],
                    hlpUseMousewheel: ['Utilice la rueda del ratón<br>para facilitar la visualización', 'Используйте колесо мыши<br>для листания'],
                    hlpUseMousewheelGL: [
                        ['Utilice la rueda del ratón', 'para facilitar la visualización'],
                        ['Используйте колесо', 'мыши для листания']
                    ],
                    ...
                    buildZoomLayer: function() {
                        var $zoomLayer = $('<div id="' + nm + '"></div>')
                            .css({
                                ...
                                cursor: 'pointer',
                                opacity: 0.5,
                                zIndex: _this.CFG.ZINDEX.zoomLayer
                            }).click(function() {
            ...
            createGlHlpLayer: function() {
                ...
                var fn = {
                    ...
                    hlpLeftImage: function(skin) {
                        ...
                        var cnv = document.createElement('canvas');
                        cnv.width = hlpImageSize.width;
                        cnv.height = hlpImageSize.height;
                        var ctx = cnv.getContext("2d");
            ...
            behavior: function() {
                ...
                var waiting_zoom = function(stop) {
                    var i = 0,
                        tmr, p = { time: 20, start: 5, pause: 40 },
                        k = 360 / (p.time - p.start),
                        started = false;
                        ...
                        for (var m = 0; m < edges3d.length; m++) {
                            ...
                            var $div = $('<div style="border:0px solid red;" class="unselectable frame' + frame + '-' + m + '">' + backEdge + frontEdge + '</div>')
                                .css({
                                    ...
                                    left: '0px',
                                    width: width + 'px',
                                    height: _this.CFG.BOOK_SIZE.height + 'px',
                                    'transform': transform,
            ...
            createImageFromColor: function(src, sheet, page) {
                ...
                var colorImage = function() {
                    var canvas = document.createElement('canvas');
                    var w = _this.CFG.BOOK_SIZE.width,
                        h = _this.CFG.BOOK_SIZE.height;
            ...
            buildResizedImage: function(bookSize, scale, imgWithParam, isSelfShadow) {
                ...
                if (this.GLOSSY) {
                    ...
                    if (!fv && sh > parseInt(String.fromCharCode(50), 10)) {
                        ...
                        ctx2.lineTo(0, 0);
                        ctx2.lineTo(0, vline);
                        ctx2.moveTo(w2 - hline, 0);
                        ctx2.lineTo(w2, 0);
                        ctx2.lineTo(w2, vline);
                        ctx2.moveTo(w2, h2 - vline);
                        ctx2.lineTo(w2, h2);
                        ctx2.lineTo(w2 - hline, h2);
                        ctx2.moveTo(0, h2 - vline);
                        ctx2.lineTo(0, h2);
                        ctx2.lineTo(hline, h2);
                        ctx2.stroke();
...
(function(e) {
    e.fn.swipeMePls = function(t) {
        var n = e.extend({ preventDefault: true, enableMouse: true, distance: 100, onTouch: function(e) {}, onMove: function(e) {}, onSwipe: function(e) {}, onEnd: function() {} }, t || {});
        var r;
        var i;
        return this.each(function() {
            ...
            if (n.enableMouse) {
                t.mousedown(function(e) { var e = e || window.event; var t = e.keyCode || e.which; if (t == 1) { l.mouseDown(e) } });
                t.mouseup(l.moveEnd);
