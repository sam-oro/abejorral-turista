...
INSERT INTO `tblmunicipios` (`id_Municipio`, `Id_Departamento`, `codigo`, `nombre`) VALUES
(1, 1, 1, 'MEDELLIN'),
(2, 1, 2, 'ABEJORRAL'),
(3, 1, 4, 'ABRIAQUI'),
(4, 1, 21, 'ALEJANDRIA'),
...
--
-- Estructura de tabla para la tabla `tblproveedor_natural`
--

CREATE TABLE `tblproveedor_natural` (
  `Cod_Prove` int(11) NOT NULL,
  `Id_Prove` varchar(50) DEFAULT NULL,
...
INSERT INTO `tblrol` (`Id_Rol`, `Nombre`) VALUES
(1, 'Admintrador'),
(2, 'Usuario'),
(3, 'Empresa');
...
--
-- Estructura de tabla para la tabla `tblsitio`
--
...
CREATE TABLE `tblsolicitud` (
  ...
  `Rango_Solicitud` double(8,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `tblcliente`
  ...
  ADD KEY `fk_tblCliente_tblMunicipios1_idx` (`id_Municipio`),
...
ALTER TABLE `tblempresa`
  ...
  ADD KEY `fk_tblEmpresa_tblMunicipios1_idx` (`Id_Municipio`),
  ADD KEY `Correo` (`Correo`);
...
ALTER TABLE `tblproveedor_natural`
  ...
  ADD KEY `fk_tblProveedor_Natural_tblMunicipios1_idx` (`Id_Municipio`);
...
--
ALTER TABLE `tblcliente`
  ADD CONSTRAINT `fk_tblCliente_tblMunicipios1` FOREIGN KEY (`id_Municipio`) REFERENCES `tblmunicipios` (`id_Municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `tblcliente_ibfk_1` FOREIGN KEY (`Correo`) REFERENCES `tbllogin` (`Correo`);

--
-- Filtros para la tabla `tblempresa`
--
ALTER TABLE `tblempresa`
  ADD CONSTRAINT `fk_tblEmpresa_tblMunicipios1` FOREIGN KEY (`Id_Municipio`) REFERENCES `tblmunicipios` (`id_Municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `tblempresa_ibfk_1` FOREIGN KEY (`Correo`) REFERENCES `tbllogin` (`Correo`);
...
--
ALTER TABLE `tblmunicipios`
  ADD CONSTRAINT `municipios_ibfk_1` FOREIGN KEY (`Id_Departamento`) REFERENCES `tbldepartamentos` (`Id_Departamento`);
